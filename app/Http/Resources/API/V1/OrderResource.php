...
class OrderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'services' => (float) number_format((float) $this->services, 2, '.', ''),
            'taxes' => (float) number_format((float) $this->taxes, 2, '.', ''),
            'final_total' => (float) number_format((float) $this->final_total, 2, '.', ''),
